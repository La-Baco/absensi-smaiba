                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="stats-icon green">
                                                <i class="iconly-boldTick-Square"></i> <!-- ikon hadir -->
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">Hadir Hari Ini</h6>
                                            <h6 class="font-extrabold mb-0">{{ $hadirHariIni }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="stats-icon red">
                                                <i class="iconly-boldClose-Square"></i> <!-- ikon alpha/tidak hadir -->
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">Alpha Hari Ini</h6>
                                            <h6 class="font-extrabold mb-0">{{ $alphaHariIni }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="stats-icon purple">
                                                <i class="iconly-boldInfo-Square"></i> <!-- ikon izin -->
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">Izin Hari Ini</h6>
                                            <h6 class="font-extrabold mb-0">{{ $izinHariIni }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="stats-icon blue">
                                                <i class="iconly-boldActivity"></i> <!-- ikon sakit -->
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">Sakit Hari Ini</h6>
                                            <h6 class="font-extrabold mb-0">{{ $sakitHariIni }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
