                ...
                <div class="p-4 h-100 d-flex flex-column justify-content-between text-white">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <div class="photo-placeholder border border-white d-flex align-items-center justify-content-center text-white text-opacity-50"
                                style="border-style: dashed;">FOTO</div>
                    ...
                    <div class="row gx-3 mb-2">
                        <div class="col-6">
                            ...
                            <div class="border-bottom border-white-50 py-1" id="namaDisplay">[NAMA GURU]</div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <div class="border-bottom border-white-50 py-1" id="nipDisplay">[NIP]</div>
                        </div>
                    </div>

                    <div class="text-center py-1 bg-dark bg-opacity-50">
